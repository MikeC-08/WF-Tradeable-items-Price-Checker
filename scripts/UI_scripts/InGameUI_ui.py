...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.item_1, 1, 0, 1, 1)
        ...
        self.price_1.setFont(font1)
        self.price_1.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.price_1, 1, 1, 1, 1)

        self.item_2 = QLabel(Form)
        self.item_2.setObjectName(u"item_2")
        self.item_2.setFont(font1)

        self.gridLayout.addWidget(self.item_2, 5, 0, 1, 1)

        self.item_3 = QLabel(Form)
        self.item_3.setObjectName(u"item_3")
        self.item_3.setFont(font1)

        self.gridLayout.addWidget(self.item_3, 7, 0, 1, 1)

        self.item_4 = QLabel(Form)
        self.item_4.setObjectName(u"item_4")
        self.item_4.setFont(font1)

        self.gridLayout.addWidget(self.item_4, 9, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.price_4, 9, 1, 1, 1)
